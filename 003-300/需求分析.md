...
**第 4 步：LED 光源 (WS2812B) 测试**

*   **目的：** 控制 WS2812B LED 的颜色和亮度。
*   **连接：**
...
*   **代码示例 (使用 Adafruit_NeoPixel 库)：**
    ...
    #define LED_COUNT  1  // LED 数量 (根据您的灯带修改)
...
*   **代码示例：**
    ...
    const char* ssid     = "YOUR_WIFI_SSID";       // 替换为您的 WiFi 名称
    const char* password = "YOUR_WIFI_PASSWORD"; // 替换为您的 WiFi 密码
